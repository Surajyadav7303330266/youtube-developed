...
$uucquery = "select * from users where userid='$userid'";
$uucdata = mysqli_query($conn,$uucquery);
$uucresult = mysqli_fetch_assoc($uucdata);
...
<!---------------------bannerAd------------------>
            <div class="bannerAd">
                <img src="../images/channel.jpg" style="height:200px;width:100%">
            </div><br>
            <table style="width:100%;height:100px">
            <tr>
                <td valign="top" width="100px">
                    <img src="<?php echo $uucresult["photo"]; ?>" style="height:80px;
                    width:80px;border-radius:50%">
                </td>
                <td valign="top">
                    <h1><?php echo $uucresult["firstname"]; ?></h1>
                </td>
                <td>
...
{
    echo    "
    <a href='videoOnClickPage_usi.php?videoid=$ucresult[videoid]'>
    <div class='col-sm-4'>
