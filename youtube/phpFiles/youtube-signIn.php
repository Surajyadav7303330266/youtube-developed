...
{
    echo    "
    <a href='videoOnClickPage_si.php?videoid=$vresult[videoid]'>
    <div class='col-sm-4'>
        <table style='width:280px;'>
            ...
            <tr>
                <td style='height: 40px;width:40px;'>
                    <img src='".$vresult['photo']."'
                        style='height:40px;width:40px;border-radius:50%;margin-top:-70px;'>
                </td>
